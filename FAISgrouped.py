...
if __name__ == "__main__":
    ...
    category_keywords = {
        "educacao": ["escola", "matricula", "transporte", "estudo", "material"],
        "acao_social": ["apoio", "alimentar", "renda", "habitacional", "psicologico", "rendimento"],
        "cultura": ["evento", "cultura", "oficina", "arte", "exposicao", "artista"]
    }
